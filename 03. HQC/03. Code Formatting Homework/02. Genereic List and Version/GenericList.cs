...
namespace _03.Genereic_List_and_Version
{
    ...
    public class GenericList<T> : IEnumerable where T : IComparable
    {
        ...
        /// <summary>
        /// Gets the current capacity of the GenericList. If the number of elements exceeds the capacity, the capacity is
        /// doubled.
        /// </summary>
        /// <value>
        /// The capacity.
        ...
        /// <summary>
        ///     Searches for the first occurrence of the specified element in the list and returns its index if found, -1
        ///     otherwise.
        ...
        public int IndexOf(T elementToFind)
        {
            ...
            {
                if (ReferenceEquals(this.array[index], elementToFind))
                {
                    return index;
                }
